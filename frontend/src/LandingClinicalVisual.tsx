...
export default function LandingClinicalVisual({ motionEnabled }: { motionEnabled: boolean }) {
  ...
  const views = [
    {
      ...
      icon: ScanLine,
      eyebrow: t('landingVisualRadiologyEyebrow'),
      title: t('landingVisualRadiologyTitle'),
      description: t('landingVisualRadiologyText'),
      tags: [t('landingImage'), t('landingSlice'), t('landingMeasurement')],
    },
    {
      id: 'evidence' as const,
      label: t('landingEvidence'),
      icon: Layers3,
      eyebrow: t('landingVisualEvidenceEyebrow'),
      title: t('landingVisualEvidenceTitle'),
      description: t('landingVisualEvidenceText'),
      tags: [t('landingHistory'), t('landingDocument'), t('landingConfirmation')],
    },
    {
      id: 'risk' as const,
      label: t('landingRisk'),
      icon: ShieldCheck,
      eyebrow: t('landingVisualRiskEyebrow'),
      title: t('landingVisualRiskTitle'),
      description: t('landingVisualRiskText'),
      tags: [t('landingAge'), t('landingBloodPressure'), t('landingHistory')],
    },
  ]
  ...
  return (
    <div
      ...
      className="lcv-root"
      data-view={view}
      data-animated={motionEnabled && isInView && !reduceMotion}
    >
      <div className="lcv-instrument">
        <div className="lcv-instrument-header">
          <span className="lcv-instrument-title">
            <span className="lcv-header-symbol">
              <Activity size={14} />
            </span>
            {t('landingClinicalView')}
          </span>
          <span className="lcv-sample">
            <span />
            {t('landingInteractiveSample')}
          </span>
        </div>
        ...
        <div className="lcv-stage">
          ...
          <span className="lcv-orientation" aria-hidden="true">
            {t('landingAnterior')}
          </span>

          <svg
            className="lcv-anatomy"
            viewBox="0 0 520 365"
            role="img"
            aria-label={t('landingAnatomyAlt')}
          >
            <defs>
              ...
              <clipPath id={`${prefix}-thorax`}>
                <rect x="113" y="43" width="294" height="266" rx="90" />
              </clipPath>
            </defs>
            ...
            <g className="lcv-orbits" fill="none" stroke="#96bfae">
              ...
              <ellipse
                ...
                ry="70"
                strokeOpacity=".11"
                transform="rotate(-25 260 187)"
              />
            </g>
            <g className="lcv-orbit-dot">
              <circle cx="428" cy="187" r="3" fill="#d4ecac" />
              <circle cx="428" cy="187" r="8" fill="#d4ecac" opacity=".12" />
            </g>
            ...
            >
              ...
              <path
                d="M152 213Q197 188 238 165M283 159Q327 184 373 190M299 222Q334 218 371 237"
                fill="none"
                strokeOpacity=".29"
              />
            </g>
            ...
            >
              <path
                d="M256 45V119Q256 139 229 151M264 45V119Q264 139 291 151"
                strokeWidth="3"
                strokeOpacity=".75"
              />
              <path
                d="M229 151 206 132 196 111M219 143 192 146 175 137M226 150 210 175 184 188 164 181M209 177 207 209 182 234M208 205 229 230M194 183 177 214M291 151 314 132 324 111M301 143 328 146 345 137M294 151 310 175 336 188 356 181M311 177 316 204 337 237M321 208 309 233M326 183 343 214"
                strokeWidth="1.65"
                strokeOpacity=".6"
              />
              <path
                d="M197 114 212 110M184 143 178 156M177 185 162 201M180 232 173 244M324 113 308 108M337 143 343 156M344 184 361 201M338 232 345 245"
                strokeWidth="1"
                strokeOpacity=".35"
              />
            </g>
            ...
            <g clipPath={`url(#${prefix}-thorax)`} className="lcv-scan-clip">
              <g className="lcv-scan-plane">
                <rect x="113" y="93" width="294" height="68" fill={`url(#${prefix}-scan)`} />
                <path d="M113 161H407" stroke="#dbefb5" strokeWidth="1.6" />
                <path d="M113 164H407" stroke="#dbefb5" strokeOpacity=".15" strokeWidth="4" />
              </g>
            </g>

            <g className="lcv-evidence-links" fill="none" stroke="#d4ecac" strokeWidth="1">
              <path
                d="M199 144 147 115H96M319 191 377 154H427M228 232 172 278H101"
                strokeOpacity=".65"
                strokeDasharray="3 5"
              />
              <circle cx="199" cy="144" r="4" fill="#d4ecac" />
              <circle cx="319" cy="191" r="4" fill="#d4ecac" />
              <circle cx="228" cy="232" r="4" fill="#d4ecac" />
              <circle className="lcv-node-pulse" cx="199" cy="144" r="11" strokeOpacity=".45" />
              <circle
                className="lcv-node-pulse lcv-node-pulse-two"
                cx="319"
                cy="191"
                r="11"
                strokeOpacity=".45"
            ...
            <g className="lcv-risk-ring" fill="none" stroke="#dbb987">
              <circle
                cx="260"
                cy="185"
                r="131"
              ...
              />
              <path
                d="M166 94A131 131 0 0 1 375 122M379 239A131 131 0 0 1 166 276"
                strokeWidth="2"
                strokeOpacity=".7"
              />
            </g>
          ...
          <div className="lcv-source-label lcv-source-one">
            <span className="lcv-source-dot" />
            {active.tags[0]}
          </div>
          <div className="lcv-source-label lcv-source-two">
            <span className="lcv-source-dot" />
            {active.tags[1]}
          </div>
          <div className="lcv-source-label lcv-source-three">
            <span className="lcv-source-dot" />
            {active.tags[2]}
          </div>
          ...
          <div className="lcv-bottom-instrument">
            ...
            <svg className="lcv-ecg" viewBox="0 0 140 22" aria-hidden="true">
              <path
                d="M0 12H25L30 9 35 14 43 12H55L60 3 66 21 72 8 78 12H102L109 9 116 12H140"
                fill="none"
                stroke="currentColor"
                strokeWidth="1.3"
              />
              <circle className="lcv-ecg-dot" cx="2" cy="12" r="2.5" fill="currentColor" />
            </svg>
          </div>
        </div>
        ...
        <div className="lcv-view-controls" role="group" aria-label={t('landingSampleView')}>
          {views.map(({ id, label, icon: Icon }) => (
            <button
              key={id}
              type="button"
              className={`lcv-view-button${view === id ? ' lcv-view-button-active' : ''}`}
              aria-pressed={view === id}
              onClick={() => setView(id)}
            >
              <Icon size={16} strokeWidth={1.6} />
              <span>{label}</span>
              {view === id && <ArrowUpRight size={13} className="lcv-tab-arrow" />}
            </button>
          ))}
        </div>
      </div>
      ...
      <div className="lcv-caption" aria-live="polite" aria-atomic="true">
        <div className="lcv-caption-heading">
          <span>{active.eyebrow}</span>
          <span className="lcv-caption-count">
            0{views.findIndex((item) => item.id === view) + 1}
            <span> / 03</span>
          </span>
        </div>
        <h3>{active.title}</h3>
