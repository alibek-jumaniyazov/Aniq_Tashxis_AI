export const patientRu = {
  ...
  newPatientIntro: 'Обязательно только ФИО. Остальные поля можно оставить пустыми. Код пациента программа создаст автоматически.',
  patientAgeHelp: 'Полных лет, от 0 до 120. Если возраст неизвестен, оставьте поле пустым.',
  patientAgeUnknown: 'Возраст не указан',
  patientAgeForClinicalAI: 'Для диагностического разбора укажите возраст пациента от 18 лет. Текущий клинический контур рассчитан на взрослых.',
  ...
  patientLegacyNameHelp: 'В этой ранее созданной записи ФИО не указано. Добавьте его, если оно известно.',
...
export const patientUz: typeof patientRu = {
  ...
  newPatientIntro: 'Faqat F.I.Sh. majburiy. Qolgan maydonlarni bo‘sh qoldirish mumkin. Bemor kodini dastur avtomatik yaratadi.',
  ...
  patientAgeForClinicalAI: 'Diagnostik tahlil uchun bemorning 18 yosh yoki undan kattaligini kiriting. Joriy klinik tahlil kattalar uchun mo‘ljallangan.',
  ...
  patientLegacyNameHelp: 'Avval yaratilgan bu yozuvda F.I.Sh. ko‘rsatilmagan. Ma’lum bo‘lsa, qo‘shing.',
...
export const patientEn: typeof patientRu = {
  ...
  newPatientIntro: 'Only the full name is required. Leave any other fields empty if needed. The application generates the patient code automatically.',
  patientAgeHelp: 'Completed years, from 0 to 120. Leave empty if the age is unknown.',
  patientAgeUnknown: 'Age not provided',
  patientAgeForClinicalAI: 'Enter a patient age of 18 or older for diagnostic review. The current clinical scope covers adults.',
