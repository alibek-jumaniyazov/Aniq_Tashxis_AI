...
export default defineConfig({
  ...
  webServer: [
    { command: `"${python}" -m uvicorn app.main:app --app-dir ../backend --host 127.0.0.1 --port 8001 --no-access-log`, url: 'http://127.0.0.1:8001/api/v1/health/live', reuseExistingServer: false, timeout: 30000, env: { DATABASE_URL: `sqlite:///${root}/runtime/e2e.db`, STORAGE_ROOT: `${root}/runtime/e2e-files`, QUEUE_MODE: 'inline', SEED_PROFILE: 'minimal', MODEL_PATH: '', DEMO_MODE: 'true', ALLOWED_ORIGINS: 'http://127.0.0.1:5174' } },
