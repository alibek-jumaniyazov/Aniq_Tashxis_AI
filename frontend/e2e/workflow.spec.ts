...
test('real API: sign in, create case, confirm fact and analyse; responsive views', async ({ page }) => {
  ...
  await page.getByLabel('ФИО пациента', { exact: true }).fill('Synthetic Workflow Patient ' + Date.now())
  await page.getByLabel('Возраст', { exact: true }).fill('45')
  await page.getByLabel('Комментарии врача', { exact: true }).fill('Synthetic end-to-end review. No real patient data.')
